####Alexander Sanilippo
####10 August, 2022
#### breif:  reads in the genomes from genome_data.csv, builds them in
#### keras, and then graphs them.  The image is stored in a .png named
#### MODELN.png where "N" is the index of the genome in the genome_data
#### file, starting from index 0.


   

#brief: Buildings and graphs the NN
...
node_list = []
#stores list of names of all named layers-used for weight setting part
layer_name_list = []
